...
{
    public class ListClosedWorkflowExecutionsOperation : Operation
    {
        public override string Name => "ListClosedWorkflowExecutions";
        ...
        public override async void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            do
            {
                try
                {
                    ...
                    resp = await client.ListClosedWorkflowExecutionsAsync(req);
